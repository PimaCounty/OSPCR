...
using Serilog;
using static PriorityCulturalResourcesWeb.Context;
...
namespace PriorityCulturalResourcesWeb
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IServiceProvider isp)
        {
            ...
            /*
              Seed a test user with Admin privileges for development purposes.

              This is controlled by DevSettings:SeedTestUser in appsettings.json
            */
